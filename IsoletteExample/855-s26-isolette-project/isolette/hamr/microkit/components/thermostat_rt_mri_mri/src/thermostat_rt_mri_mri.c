...
volatile sb_queue_Isolette_Data_Model_Temp_i_1_t *upper_desired_temp_queue_1 = (volatile sb_queue_Isolette_Data_Model_Temp_i_1_t *) 0x10000000;
volatile sb_queue_Isolette_Data_Model_Temp_i_1_t *lower_desired_temp_queue_1 = (volatile sb_queue_Isolette_Data_Model_Temp_i_1_t *) 0x10001000;
volatile sb_queue_Isolette_Data_Model_Temp_i_1_t *displayed_temp_queue_1 = (volatile sb_queue_Isolette_Data_Model_Temp_i_1_t *) 0x10002000;
volatile sb_queue_Isolette_Data_Model_Status_1_t *regulator_status_queue_1 = (volatile sb_queue_Isolette_Data_Model_Status_1_t *) 0x10003000;
volatile sb_queue_Isolette_Data_Model_Failure_Flag_i_1_t *interface_failure_queue_1 = (volatile sb_queue_Isolette_Data_Model_Failure_Flag_i_1_t *) 0x10004000;
volatile sb_queue_Isolette_Data_Model_Regulator_Mode_1_t *regulator_mode_queue_1 = (volatile sb_queue_Isolette_Data_Model_Regulator_Mode_1_t *) 0x10005000;
sb_queue_Isolette_Data_Model_Regulator_Mode_1_Recv_t regulator_mode_recv_queue;
volatile sb_queue_Isolette_Data_Model_TempWstatus_i_1_t *lower_desired_tempWstatus_queue_1 = (volatile sb_queue_Isolette_Data_Model_TempWstatus_i_1_t *) 0x10006000;
sb_queue_Isolette_Data_Model_TempWstatus_i_1_Recv_t lower_desired_tempWstatus_recv_queue;
volatile sb_queue_Isolette_Data_Model_TempWstatus_i_1_t *upper_desired_tempWstatus_queue_1 = (volatile sb_queue_Isolette_Data_Model_TempWstatus_i_1_t *) 0x10007000;
sb_queue_Isolette_Data_Model_TempWstatus_i_1_Recv_t upper_desired_tempWstatus_recv_queue;
volatile sb_queue_Isolette_Data_Model_TempWstatus_i_1_t *current_tempWstatus_queue_1 = (volatile sb_queue_Isolette_Data_Model_TempWstatus_i_1_t *) 0x10008000;
