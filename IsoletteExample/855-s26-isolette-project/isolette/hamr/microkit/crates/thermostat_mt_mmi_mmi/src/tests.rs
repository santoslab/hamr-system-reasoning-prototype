...
mod tests {
  ...
  fn test_compute() {
    ...
    test_api::put_upper_alarm_tempWstatus(Isolette_Data_Model::TempWstatus_i::default());
    test_api::put_lower_alarm_tempWstatus(Isolette_Data_Model::TempWstatus_i::default());
...
mod GUMBOX_tests {
  ...
  */
  ...
  testComputeCB_macro! {
    ...
    api_lower_alarm_tempWstatus: test_api::Isolette_Data_Model_TempWstatus_i_strategy_default(),
    api_monitor_mode: test_api::Isolette_Data_Model_Monitor_Mode_strategy_default(),
    api_upper_alarm_tempWstatus: test_api::Isolette_Data_Model_TempWstatus_i_strategy_default()
    */
    api_current_tempWstatus: test_api::Isolette_Data_Model_TempWstatus_i_strategy_default(),
    api_lower_alarm_tempWstatus: test_api::Isolette_Data_Model_TempWstatus_i_strategy_cust(
      lower_alarm_temp_range, test_api::Isolette_Data_Model_ValueStatus_strategy_default()),
    api_monitor_mode: test_api::Isolette_Data_Model_Monitor_Mode_strategy_default(),
    api_upper_alarm_tempWstatus: test_api::Isolette_Data_Model_TempWstatus_i_strategy_cust(
      upper_alarm_temp_range, test_api::Isolette_Data_Model_ValueStatus_strategy_default())
  }
