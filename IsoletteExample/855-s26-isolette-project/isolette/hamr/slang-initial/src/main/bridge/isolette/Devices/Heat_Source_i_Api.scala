...
@datatype class Heat_Source_i_Initialization_Api (
  val id: Art.BridgeId,
  val heat_control_Id : Art.PortId,
  val heat_out_Id : Art.PortId) extends Heat_Source_i_Api

@datatype class Heat_Source_i_Operational_Api (
  val id: Art.BridgeId,
  val heat_control_Id : Art.PortId,
  val heat_out_Id : Art.PortId) extends Heat_Source_i_Api {
