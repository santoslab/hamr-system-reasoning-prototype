...
@sig trait Manage_Monitor_Mode_i_Api {
  def id: Art.BridgeId
...
@datatype class Manage_Monitor_Mode_i_Initialization_Api (
  val id: Art.BridgeId,
  val current_tempWstatus_Id : Art.PortId,
  val interface_failure_Id : Art.PortId,
  val internal_failure_Id : Art.PortId,
  val monitor_mode_Id : Art.PortId) extends Manage_Monitor_Mode_i_Api

@datatype class Manage_Monitor_Mode_i_Operational_Api (
  val id: Art.BridgeId,
  val current_tempWstatus_Id : Art.PortId,
  val interface_failure_Id : Art.PortId,
  val internal_failure_Id : Art.PortId,
