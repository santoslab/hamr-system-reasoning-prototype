...
object MsgPack {
  ...
  object Constants {
    ...
    val MonitorManage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_P: Z = 12

    val MonitorManage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_PS: Z = 13

    val MonitorManage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PostState_Container_P: Z = 14

    val MonitorManage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PostState_Container_PS: Z = 15

    val MonitorManage_Alarm_i_thermostat_mt_ma_ma_PreState_Container_P: Z = 16

    val MonitorManage_Alarm_i_thermostat_mt_ma_ma_PreState_Container_PS: Z = 17

    val MonitorManage_Alarm_i_thermostat_mt_ma_ma_PostState_Container_P: Z = 18

    val MonitorManage_Alarm_i_thermostat_mt_ma_ma_PostState_Container_PS: Z = 19

    val MonitorManage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PreState_Container_P: Z = 20

    val MonitorManage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PreState_Container_PS: Z = 21

    val MonitorManage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PostState_Container_P: Z = 22

    val MonitorManage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PostState_Container_PS: Z = 23

    val Operator_InterfaceOperator_Interface_Thread_i_operator_interface_oip_oit_PreState_Container_P: Z = 24

    val Operator_InterfaceOperator_Interface_Thread_i_operator_interface_oip_oit_PreState_Container_PS: Z = 25

    val Operator_InterfaceOperator_Interface_Thread_i_operator_interface_oip_oit_PostState_Container_P: Z = 26

    val Operator_InterfaceOperator_Interface_Thread_i_operator_interface_oip_oit_PostState_Container_PS: Z = 27

    val utilEmptyContainer: Z = 28
