...
@msig trait Manage_Alarm_i_thermostat_mt_ma_ma_GumboX_TestHarness extends Manage_Alarm_i_thermostat_mt_ma_ma_TestApi {
  def verbose: B
  ...
  def testInitialiseCB(
    ...
    val lastCmd: Isolette_Data_Model.On_Off.Type = isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma.lastCmd
    ...
    val postResult = isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma_GumboX.inititialize_IEP_Post(lastCmd, api_alarm_control)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    isolette.JSON.toMonitorManage_Alarm_i_thermostat_mt_ma_ma_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: Manage_Alarm_i_thermostat_mt_ma_ma_PreState_Container): GumboXResult.Type = {
  ...
  def testComputeCB(
      ...
      api_upper_alarm_temp: Isolette_Data_Model.Temp_i): GumboXResult.Type = {
    ...
    val In_lastCmd: Isolette_Data_Model.On_Off.Type = isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma.lastCmd

    // [CheckPre]: check/filter based on pre-condition.
    val CEP_Pre_Result: B = isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma_GumboX.compute_CEP_Pre (In_lastCmd, api_current_tempWstatus, api_lower_alarm_temp, api_monitor_mode, api_upper_alarm_temp)
    if (!CEP_Pre_Result) {
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma_GumboX.compute_CEP_Post(In_lastCmd, lastCmd, api_current_tempWstatus, api_lower_alarm_temp, api_monitor_mode, api_upper_alarm_temp, api_alarm_control)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    isolette.JSON.toMonitorManage_Alarm_i_thermostat_mt_ma_ma_PreState_Container_PS(json) match {
      case Either.Left(o) => return testComputeCBwLV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBwLV(o: Manage_Alarm_i_thermostat_mt_ma_ma_PreState_Container_PS): GumboXResult.Type = {
  ...
  def testComputeCBwL(
    ...
    isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma.lastCmd = In_lastCmd
