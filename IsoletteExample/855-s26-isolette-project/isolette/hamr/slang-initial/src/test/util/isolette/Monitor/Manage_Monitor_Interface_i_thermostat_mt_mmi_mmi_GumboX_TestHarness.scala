...
@msig trait Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX_TestHarness extends Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_TestApi {
  def verbose: B
  ...
  def testInitialiseCB(
    ...
    val api_interface_failure: Isolette_Data_Model.Failure_Flag_i = get_interface_failure().get
    val api_lower_alarm_temp: Isolette_Data_Model.Temp_i = get_lower_alarm_temp().get
    val api_monitor_status: Isolette_Data_Model.Status.Type = get_monitor_status().get
    val api_upper_alarm_temp: Isolette_Data_Model.Temp_i = get_upper_alarm_temp().get
    val lastCmd: Isolette_Data_Model.On_Off.Type = isolette.Monitor.Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi.lastCmd
    ...
    val postResult = isolette.Monitor.Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX.inititialize_IEP_Post(lastCmd, api_interface_failure, api_lower_alarm_temp, api_monitor_status, api_upper_alarm_temp)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    isolette.JSON.toMonitorManage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container): GumboXResult.Type = {
  ...
  def testComputeCB(
      ...
      api_upper_alarm_tempWstatus: Isolette_Data_Model.TempWstatus_i): GumboXResult.Type = {
    ...
    val In_lastCmd: Isolette_Data_Model.On_Off.Type = isolette.Monitor.Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi.lastCmd

    // [CheckPre]: check/filter based on pre-condition.
    val CEP_Pre_Result: B = isolette.Monitor.Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX.compute_CEP_Pre (In_lastCmd, api_current_tempWstatus, api_lower_alarm_tempWstatus, api_monitor_mode, api_upper_alarm_tempWstatus)
    if (!CEP_Pre_Result) {
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = isolette.Monitor.Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX.compute_CEP_Post(In_lastCmd, lastCmd, api_current_tempWstatus, api_lower_alarm_tempWstatus, api_monitor_mode, api_upper_alarm_tempWstatus, api_interface_failure, api_lower_alarm_temp, api_monitor_status, api_upper_alarm_temp)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    isolette.JSON.toMonitorManage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_PS(json) match {
      case Either.Left(o) => return testComputeCBwLV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBwLV(o: Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_PS): GumboXResult.Type = {
  ...
  def testComputeCBwL(
    ...
    isolette.Monitor.Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi.lastCmd = In_lastCmd
