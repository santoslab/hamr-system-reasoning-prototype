...
abstract class Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX_TestHarness {
