...
object Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_DSC_UnitTests extends Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX_UnitTests
