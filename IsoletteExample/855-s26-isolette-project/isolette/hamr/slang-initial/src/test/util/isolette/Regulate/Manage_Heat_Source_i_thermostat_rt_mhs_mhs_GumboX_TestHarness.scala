...
@msig trait Manage_Heat_Source_i_thermostat_rt_mhs_mhs_GumboX_TestHarness extends Manage_Heat_Source_i_thermostat_rt_mhs_mhs_TestApi {
  def verbose: B
  ...
  def testInitialiseCB(
    ...
    val lastCmd: Isolette_Data_Model.On_Off.Type = isolette.Regulate.Manage_Heat_Source_i_thermostat_rt_mhs_mhs.lastCmd
    ...
    val postResult = isolette.Regulate.Manage_Heat_Source_i_thermostat_rt_mhs_mhs_GumboX.inititialize_IEP_Post(lastCmd, api_heat_control)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    isolette.JSON.toRegulateManage_Heat_Source_i_thermostat_rt_mhs_mhs_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: Manage_Heat_Source_i_thermostat_rt_mhs_mhs_PreState_Container): GumboXResult.Type = {
  ...
  def testComputeCB(
      ...
      api_upper_desired_temp: Isolette_Data_Model.Temp_i): GumboXResult.Type = {
    ...
    val In_lastCmd: Isolette_Data_Model.On_Off.Type = isolette.Regulate.Manage_Heat_Source_i_thermostat_rt_mhs_mhs.lastCmd

    // [CheckPre]: check/filter based on pre-condition.
    val CEP_Pre_Result: B = isolette.Regulate.Manage_Heat_Source_i_thermostat_rt_mhs_mhs_GumboX.compute_CEP_Pre (In_lastCmd, api_current_tempWstatus, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp)
    if (!CEP_Pre_Result) {
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = isolette.Regulate.Manage_Heat_Source_i_thermostat_rt_mhs_mhs_GumboX.compute_CEP_Post(In_lastCmd, lastCmd, api_current_tempWstatus, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp, api_heat_control)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    isolette.JSON.toRegulateManage_Heat_Source_i_thermostat_rt_mhs_mhs_PreState_Container_PS(json) match {
      case Either.Left(o) => return testComputeCBwLV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBwLV(o: Manage_Heat_Source_i_thermostat_rt_mhs_mhs_PreState_Container_PS): GumboXResult.Type = {
  ...
  def testComputeCBwL(
    ...
    isolette.Regulate.Manage_Heat_Source_i_thermostat_rt_mhs_mhs.lastCmd = In_lastCmd
