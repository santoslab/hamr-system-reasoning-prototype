...
abstract class Manage_Heat_Source_i_thermostat_rt_mhs_mhs_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Manage_Heat_Source_i_thermostat_rt_mhs_mhs_GumboX_TestHarness {
