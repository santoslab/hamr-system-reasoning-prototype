...
object Manage_Regulator_Interface_i_thermostat_rt_mri_mri_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Manage_Regulator_Interface_i_thermostat_rt_mri_mri_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Manage_Regulator_Interface_i_thermostat_rt_mri_mri_DSC_UnitTests extends Manage_Regulator_Interface_i_thermostat_rt_mri_mri_GumboX_UnitTests
