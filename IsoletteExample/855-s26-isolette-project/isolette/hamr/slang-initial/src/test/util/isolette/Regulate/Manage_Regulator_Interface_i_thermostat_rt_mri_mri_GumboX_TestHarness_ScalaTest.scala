...
abstract class Manage_Regulator_Interface_i_thermostat_rt_mri_mri_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Manage_Regulator_Interface_i_thermostat_rt_mri_mri_GumboX_TestHarness {
