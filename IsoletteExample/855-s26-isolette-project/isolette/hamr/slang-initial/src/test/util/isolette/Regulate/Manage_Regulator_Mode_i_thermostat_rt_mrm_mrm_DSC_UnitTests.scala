...
object Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm_DSC_UnitTests extends Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm_GumboX_UnitTests
