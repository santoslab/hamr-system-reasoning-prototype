...
abstract class Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm_GumboX_TestHarness {
