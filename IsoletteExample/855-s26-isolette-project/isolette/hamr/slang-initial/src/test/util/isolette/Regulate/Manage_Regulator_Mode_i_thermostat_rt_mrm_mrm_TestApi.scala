...
@msig trait Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm_TestApi {

  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm)
  }
  ...
  /** helper function to check Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm's
  ...
  def get_regulator_mode_payload(): Option[Isolette_Data_Model.Regulator_Mode_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm.initialization_api.regulator_mode_Id).asInstanceOf[Option[Isolette_Data_Model.Regulator_Mode_Payload]]
  }
