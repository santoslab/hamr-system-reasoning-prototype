...
val files = ISZ[C](
  ...
  C(monitorDir / "Manage_Alarm_i_thermostat_mt_ma_ma.scala", defaultOpts, emptyMap),

  C(monitorDir / "Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi.scala", defaultOpts, emptyMap),

  C(monitorDir / "Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm.scala", defaultOpts, emptyMap),

  C(regulateDir / "Manage_Heat_Source_i_thermostat_rt_mhs_mhs.scala", defaultOpts, emptyMap),

  C(regulateDir / "Manage_Regulator_Interface_i_thermostat_rt_mri_mri.scala", defaultOpts, emptyMap),

  C(regulateDir / "Manage_Regulator_Mode_i_thermostat_rt_mrm_mrm.scala", defaultOpts, emptyMap)
)
