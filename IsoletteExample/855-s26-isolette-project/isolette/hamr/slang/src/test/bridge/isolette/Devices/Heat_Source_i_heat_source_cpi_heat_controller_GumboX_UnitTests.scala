...
import isolette.Devices.Heat_Source_i_heat_source_cpi_heat_controller_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Heat_Source_i_heat_source_cpi_heat_controller_GumboX_UnitTests extends Heat_Source_i_heat_source_cpi_heat_controller_GumboX_TestHarness_ScalaTest {
