...
import isolette.Monitor.Detect_Monitor_Failure_i_thermostat_mt_dmf_dmf_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Detect_Monitor_Failure_i_thermostat_mt_dmf_dmf_GumboX_UnitTests extends Detect_Monitor_Failure_i_thermostat_mt_dmf_dmf_GumboX_TestHarness_ScalaTest {
