...
import isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Manage_Alarm_i_thermostat_mt_ma_ma_GumboX_UnitTests extends Manage_Alarm_i_thermostat_mt_ma_ma_GumboX_TestHarness_ScalaTest {
