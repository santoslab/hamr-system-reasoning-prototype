...
import isolette.Monitor.Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX_UnitTests extends Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX_TestHarness_ScalaTest {
