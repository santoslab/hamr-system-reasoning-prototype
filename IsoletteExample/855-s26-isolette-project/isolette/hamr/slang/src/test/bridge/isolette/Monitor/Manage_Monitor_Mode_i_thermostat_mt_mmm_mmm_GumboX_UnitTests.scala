...
import isolette.Monitor.Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX_UnitTests extends Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX_TestHarness_ScalaTest {
