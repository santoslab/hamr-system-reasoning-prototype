...
object Heat_Source_i_heat_source_cpi_heat_controller_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Heat_Source_i_heat_source_cpi_heat_controller_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Heat_Source_i_heat_source_cpi_heat_controller_DSC_UnitTests extends Heat_Source_i_heat_source_cpi_heat_controller_GumboX_UnitTests
