...
abstract class Heat_Source_i_heat_source_cpi_heat_controller_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Heat_Source_i_heat_source_cpi_heat_controller_GumboX_TestHarness {
