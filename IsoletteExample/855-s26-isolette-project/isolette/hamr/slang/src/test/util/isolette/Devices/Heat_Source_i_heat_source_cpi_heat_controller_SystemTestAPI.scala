...
object Heat_Source_i_heat_source_cpi_heat_controller_SystemTestAPI {
  ...
  def fetchContainer(): isolette.Devices.Heat_Source_i_heat_source_cpi_heat_controller_PostState_Container_PS = {
    if (runtimeMonitorStream.contains(Arch.Isolette_Single_Sensor_Instance_heat_source_cpi_heat_controller.id)) {
      ...
      return postContainer_.asInstanceOf[isolette.Devices.Heat_Source_i_heat_source_cpi_heat_controller_PostState_Container_PS]
    }
    else {
