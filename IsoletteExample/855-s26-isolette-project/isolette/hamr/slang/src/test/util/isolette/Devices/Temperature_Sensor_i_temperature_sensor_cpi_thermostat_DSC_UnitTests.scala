...
object Temperature_Sensor_i_temperature_sensor_cpi_thermostat_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Temperature_Sensor_i_temperature_sensor_cpi_thermostat_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Temperature_Sensor_i_temperature_sensor_cpi_thermostat_DSC_UnitTests extends Temperature_Sensor_i_temperature_sensor_cpi_thermostat_GumboX_UnitTests
