...
abstract class Temperature_Sensor_i_temperature_sensor_cpi_thermostat_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Temperature_Sensor_i_temperature_sensor_cpi_thermostat_GumboX_TestHarness {
