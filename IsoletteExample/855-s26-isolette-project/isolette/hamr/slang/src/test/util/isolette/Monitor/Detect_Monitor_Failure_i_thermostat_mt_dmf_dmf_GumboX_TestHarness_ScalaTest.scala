...
abstract class Detect_Monitor_Failure_i_thermostat_mt_dmf_dmf_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Detect_Monitor_Failure_i_thermostat_mt_dmf_dmf_GumboX_TestHarness {
