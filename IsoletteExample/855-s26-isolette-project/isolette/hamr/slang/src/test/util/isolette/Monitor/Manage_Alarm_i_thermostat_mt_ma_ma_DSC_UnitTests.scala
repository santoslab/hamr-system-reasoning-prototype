...
object Manage_Alarm_i_thermostat_mt_ma_ma_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Manage_Alarm_i_thermostat_mt_ma_ma_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Manage_Alarm_i_thermostat_mt_ma_ma_DSC_UnitTests extends Manage_Alarm_i_thermostat_mt_ma_ma_GumboX_UnitTests
