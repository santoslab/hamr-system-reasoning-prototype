...
object Manage_Alarm_i_thermostat_mt_ma_ma_SystemTestAPI {
  ...
  def put_In_lastCmd(value: Isolette_Data_Model.On_Off.Type): Unit = {
    Manage_Alarm_i_thermostat_mt_ma_ma.lastCmd = value
  }
  ...
  def fetchContainer(): isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma_PostState_Container_PS = {
    if (runtimeMonitorStream.contains(Arch.Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma.id)) {
      val (_, postContainer_) = runtimeMonitorStream.get(Arch.Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma.id).get
      return postContainer_.asInstanceOf[isolette.Monitor.Manage_Alarm_i_thermostat_mt_ma_ma_PostState_Container_PS]
    }
    else {
      assert(F, s"No post state recorded for ${Arch.Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma.name}")
      halt(s"No post state recorded for ${Arch.Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma.name}")
    }
  }
  ...
  def get_lastCmd(): Isolette_Data_Model.On_Off.Type = {
    return Manage_Alarm_i_thermostat_mt_ma_ma.lastCmd
  }
