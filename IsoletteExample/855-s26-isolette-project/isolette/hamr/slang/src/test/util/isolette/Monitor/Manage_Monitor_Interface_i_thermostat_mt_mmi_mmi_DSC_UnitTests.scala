...
object Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_DSC_UnitTests extends Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_GumboX_UnitTests
