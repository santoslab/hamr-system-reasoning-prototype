...
@msig trait Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX_TestHarness extends Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_TestApi {
  def verbose: B
  ...
  def testInitialiseCB(
    ...
    val lastMonitorMode: Isolette_Data_Model.Monitor_Mode.Type = isolette.Monitor.Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm.lastMonitorMode
    ...
    val postResult = isolette.Monitor.Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX.inititialize_IEP_Post(lastMonitorMode, api_monitor_mode)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    isolette.JSON.toMonitorManage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PreState_Container): GumboXResult.Type = {
  ...
  def testComputeCB(
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = isolette.Monitor.Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX.compute_CEP_Post(In_lastMonitorMode, lastMonitorMode, api_current_tempWstatus, api_interface_failure, api_internal_failure, api_monitor_mode)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
  ...
  def testComputeCBwLJ(json: String): GumboXResult.Type = {
    isolette.JSON.toMonitorManage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PreState_Container_PS(json) match {
      case Either.Left(o) => return testComputeCBwLV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBwLV(o: Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_PreState_Container_PS): GumboXResult.Type = {
  ...
  def testComputeCBwL(
    ...
    isolette.Monitor.Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm.lastMonitorMode = In_lastMonitorMode
