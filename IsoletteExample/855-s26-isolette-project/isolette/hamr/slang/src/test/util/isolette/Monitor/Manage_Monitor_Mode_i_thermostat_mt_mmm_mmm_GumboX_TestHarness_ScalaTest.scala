...
abstract class Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_GumboX_TestHarness {
