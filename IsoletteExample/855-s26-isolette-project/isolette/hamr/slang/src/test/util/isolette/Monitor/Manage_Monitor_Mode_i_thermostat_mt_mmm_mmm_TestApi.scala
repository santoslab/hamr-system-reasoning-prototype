...
@msig trait Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm_TestApi {

  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm)
  }
  ...
  def put_concrete_inputs(current_tempWstatus : Isolette_Data_Model.TempWstatus_i,
                          ...
                          internal_failure : Isolette_Data_Model.Failure_Flag_i): Unit = {
  ...
  /** helper function to check Manage_Monitor_Mode_i_thermostat_mt_mmm_mmm's
  ...
  def get_monitor_mode_payload(): Option[Isolette_Data_Model.Monitor_Mode_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm.initialization_api.monitor_mode_Id).asInstanceOf[Option[Isolette_Data_Model.Monitor_Mode_Payload]]
  }
