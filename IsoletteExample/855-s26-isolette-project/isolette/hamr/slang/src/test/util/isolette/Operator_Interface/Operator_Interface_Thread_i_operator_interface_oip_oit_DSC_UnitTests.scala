...
object Operator_Interface_Thread_i_operator_interface_oip_oit_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Operator_Interface_Thread_i_operator_interface_oip_oit_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Operator_Interface_Thread_i_operator_interface_oip_oit_DSC_UnitTests extends Operator_Interface_Thread_i_operator_interface_oip_oit_GumboX_UnitTests
