...
@msig trait Operator_Interface_Thread_i_operator_interface_oip_oit_TestApi {
  ...
  /** helper function to check Operator_Interface_Thread_i_operator_interface_oip_oit's
   ...
   */
  def check_concrete_output(lower_desired_tempWstatus: Isolette_Data_Model.TempWstatus_i => B,
                            upper_desired_tempWstatus: Isolette_Data_Model.TempWstatus_i => B,
                            lower_alarm_tempWstatus: Isolette_Data_Model.TempWstatus_i => B,
                            upper_alarm_tempWstatus: Isolette_Data_Model.TempWstatus_i => B): Unit = {
    var testFailures: ISZ[ST] = ISZ()

    val lower_desired_tempWstatusValue: Isolette_Data_Model.TempWstatus_i = get_lower_desired_tempWstatus().get
    ...
    val upper_desired_tempWstatusValue: Isolette_Data_Model.TempWstatus_i = get_upper_desired_tempWstatus().get
    ...
    val lower_alarm_tempWstatusValue: Isolette_Data_Model.TempWstatus_i = get_lower_alarm_tempWstatus().get
    ...
    val upper_alarm_tempWstatusValue: Isolette_Data_Model.TempWstatus_i = get_upper_alarm_tempWstatus().get
  ...
  def get_lower_desired_tempWstatus(): Option[Isolette_Data_Model.TempWstatus_i] = {
    val value: Option[Isolette_Data_Model.TempWstatus_i] = get_lower_desired_tempWstatus_payload() match {
      case Some(Isolette_Data_Model.TempWstatus_i_Payload(v)) => Some(v)
      case Some(v) => halt(s"Unexpected payload on port lower_desired_tempWstatus.  Expecting 'Isolette_Data_Model.TempWstatus_i_Payload' but received ${v}")
  ...
  def get_lower_desired_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.Isolette_Single_Sensor_Instance_operator_interface_oip_oit.initialization_api.lower_desired_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_i_Payload]]
  }

  // getter for out DataPort
  def get_upper_desired_tempWstatus(): Option[Isolette_Data_Model.TempWstatus_i] = {
    val value: Option[Isolette_Data_Model.TempWstatus_i] = get_upper_desired_tempWstatus_payload() match {
      case Some(Isolette_Data_Model.TempWstatus_i_Payload(v)) => Some(v)
      case Some(v) => halt(s"Unexpected payload on port upper_desired_tempWstatus.  Expecting 'Isolette_Data_Model.TempWstatus_i_Payload' but received ${v}")
      case _ => None[Isolette_Data_Model.TempWstatus_i]()
    }
    return value
  }
  ...
  // payload getter for out DataPort
  def get_upper_desired_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.Isolette_Single_Sensor_Instance_operator_interface_oip_oit.initialization_api.upper_desired_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_i_Payload]]
  }

  // getter for out DataPort
  def get_lower_alarm_tempWstatus(): Option[Isolette_Data_Model.TempWstatus_i] = {
    val value: Option[Isolette_Data_Model.TempWstatus_i] = get_lower_alarm_tempWstatus_payload() match {
      case Some(Isolette_Data_Model.TempWstatus_i_Payload(v)) => Some(v)
      case Some(v) => halt(s"Unexpected payload on port lower_alarm_tempWstatus.  Expecting 'Isolette_Data_Model.TempWstatus_i_Payload' but received ${v}")
      case _ => None[Isolette_Data_Model.TempWstatus_i]()
    }
    return value
  }
  ...
  // payload getter for out DataPort
  def get_lower_alarm_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.Isolette_Single_Sensor_Instance_operator_interface_oip_oit.initialization_api.lower_alarm_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_i_Payload]]
  }

  // getter for out DataPort
  def get_upper_alarm_tempWstatus(): Option[Isolette_Data_Model.TempWstatus_i] = {
    val value: Option[Isolette_Data_Model.TempWstatus_i] = get_upper_alarm_tempWstatus_payload() match {
      case Some(Isolette_Data_Model.TempWstatus_i_Payload(v)) => Some(v)
      case Some(v) => halt(s"Unexpected payload on port upper_alarm_tempWstatus.  Expecting 'Isolette_Data_Model.TempWstatus_i_Payload' but received ${v}")
      case _ => None[Isolette_Data_Model.TempWstatus_i]()
    }
    return value
  }
  ...
  // payload getter for out DataPort
  def get_upper_alarm_tempWstatus_payload(): Option[Isolette_Data_Model.TempWstatus_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.Isolette_Single_Sensor_Instance_operator_interface_oip_oit.initialization_api.upper_alarm_tempWstatus_Id).asInstanceOf[Option[Isolette_Data_Model.TempWstatus_i_Payload]]
  }
