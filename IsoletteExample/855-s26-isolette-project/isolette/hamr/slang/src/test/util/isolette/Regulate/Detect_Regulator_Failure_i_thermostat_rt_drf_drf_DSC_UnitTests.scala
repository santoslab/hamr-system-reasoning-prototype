...
object Detect_Regulator_Failure_i_thermostat_rt_drf_drf_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Detect_Regulator_Failure_i_thermostat_rt_drf_drf_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Detect_Regulator_Failure_i_thermostat_rt_drf_drf_DSC_UnitTests extends Detect_Regulator_Failure_i_thermostat_rt_drf_drf_GumboX_UnitTests
