...
abstract class Detect_Regulator_Failure_i_thermostat_rt_drf_drf_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  Detect_Regulator_Failure_i_thermostat_rt_drf_drf_GumboX_TestHarness {
