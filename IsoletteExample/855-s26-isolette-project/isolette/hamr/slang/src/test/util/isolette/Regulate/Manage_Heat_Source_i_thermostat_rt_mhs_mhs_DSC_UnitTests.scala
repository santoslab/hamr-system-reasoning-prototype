...
object Manage_Heat_Source_i_thermostat_rt_mhs_mhs_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Manage_Heat_Source_i_thermostat_rt_mhs_mhs_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Manage_Heat_Source_i_thermostat_rt_mhs_mhs_DSC_UnitTests extends Manage_Heat_Source_i_thermostat_rt_mhs_mhs_GumboX_UnitTests
